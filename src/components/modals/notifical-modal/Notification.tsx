...
import Empty from '@/assests/images/empty-notification.png';
import Close from '@/assests/icons/close.svg';
import Image from 'next/image';
import Notify from '@/assests/images/notification-image.png'
            ...
            <div className={styles.notificationContainer}>
                ...
                <div>
                    ...
                    <div className='overflow-y-scroll h-[500px] lg:h-screen'>
                        <NotificationMessage title='Welcome to Phonecom'
